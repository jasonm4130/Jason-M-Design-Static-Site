...
The site for the exhibition of the German artist’s group [http://exhibitions.guggenheim.org/](ZERO at the Guggenheim) uses sound as an atmosphere but also as a form of navigation. Sound is chosen as a tool due to its importance in the creative work of the collective. Bold ringtones establish the pieces that represent the beginnings of a theme, while the tertiary projects click in the background.
...
This post was brought to you through a partnership with the (https://www.toptal.com/)[Toptal Blog].
